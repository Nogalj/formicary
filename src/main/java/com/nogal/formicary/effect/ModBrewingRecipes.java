 ...
 *
 * <p>Ep2 task H2 adds Awkward Potion + Chitin -> Hardened Chitin on the exact same
 * {@code addMix} seam, one line below the disguise mix.
 */
...
public final class ModBrewingRecipes {
    ...
    public static void onRegisterBrewingRecipes(RegisterBrewingRecipesEvent event) {
        ...
        event.getBuilder().addMix(Potions.AWKWARD, ModItems.CHITIN.get(), ModPotions.HARDENED_CHITIN);
    }
