    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> FORMICARY_TAB = CREATIVE_MODE_TABS.register(
            ...
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(ModItems.CHITIN_PLATE.get());
                        ...
                        // Ep2 play-test revision (WP-1 item 2): replaces the five-tool
                        // Ep2 H1 set.
                        output.accept(ModItems.MANDIBLE_PICKAXE.get());
                        output.accept(ModItems.PINCER_SWORD.get());
